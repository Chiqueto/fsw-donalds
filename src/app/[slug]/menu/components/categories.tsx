        ...
        <div className="relative z-50 mt-[-1.5rem] rounded-t-3xl bg-white ">
            <div className="p-5">
                <div className="flex gap-3 items-center ">
                    ...
                    <div><h2 className="text-lg font-semibold">{restaurant.name}</h2>
                        <p className="text-xs opacity-55">{restaurant.description}</p></div>
                </div>
                <div className="flex mt-3 gap-1 items-center text-xs text-green-500">
                    <ClockIcon size={12} />
                    <p>Aberto!</p>
                </div>
            </div>
